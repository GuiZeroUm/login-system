     ...
     */
         ...
         */
            remote: function (settings) {
                ...
                $('.flexdatalist-searching .fa-spinner-third').removeClass('d-none');
                $('.flexdatalist-searching .fa-search').addClass('d-none');
                ...
                $.ajax($.extend(
                    {
                        ...
                        complete: function () {
                            ...
                            $('.flexdatalist-searching .fa-spinner-third').addClass('d-none');
                            $('.flexdatalist-searching .fa-search').removeClass('d-none');
                        }
                    }, settings, {
                        success: function (data) {
